...
/// <reference path="control-container.ts" />
...
namespace Jamble {
  ...
  export class InstrumentContainer extends UIElement {
    ...
    private controlPanel!: ControlContainer;
    ...
    private createControlPanel(): void {
      this.controlPanel = new ControlContainer(this.panelWrapper);
    }
     ...
     */
    getControlPanel(): ControlContainer {
